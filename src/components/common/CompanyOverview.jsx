  ...
  return (
    <section className="py-20 bg-gradient-to-b from-white to-secondary-light-blue/10e">
      <div className="max-w-7xl mx-auto px-6">
        {/* Header — tees up the Values section */}
        <div className="text-center mb-16">
          ...
          {/* One-line explainer that points to values */}
          <p className="max-w-3xl mx-auto text-lg text-gray-700 leading-relaxed">
            We help adults in Wales live fuller, more independent lives through
            Residential Care, Supported Living and Community Outreach.
            Everything we do is underpinned by our five core values below.
          </p>

          {/* Preview the values as chips that link to the list */}
          <div className="mt-5 flex flex-wrap items-center justify-center gap-2">
            <a
              href="#our-values"
              className="px-3 py-1.5 rounded-full text-sm bg-secondary-teal/10 text-secondary-teal font-semibold"
            >
              Aspirational
            </a>
            <a
              href="#our-values"
              className="px-3 py-1.5 rounded-full text-sm bg-secondary-coral/10 text-secondary-coral font-semibold"
            >
              Kind
            </a>
            <a
              href="#our-values"
              className="px-3 py-1.5 rounded-full text-sm bg-primary-gold/10 text-primary-navy font-semibold"
            >
              Collaborative
            </a>
            <a
          ...
          {/* Subtle inline jump link */}
          {/* <div className="mt-4">
            <a
              href="#our-values"
              className="inline-flex items-center font-semibold text-primary-navy hover:text-primary-navy/80 transition-colors"
            >
              See our values
              <svg
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-stretch">
          ...
          <div className="relative bg-gray-200 rounded-2xl overflow-hidden min-h-[600px]">
            ...
            {/* Mission Text Overlay with enhanced readability */}
            <div className="absolute bottom-0 left-0 right-0 p-8 text-white">
              <h3 className="text-2xl font-bold mb-4 drop-shadow-lg">
                Our Mission
              </h3>
              <blockquote className="text-lg leading-relaxed italic mb-4 drop-shadow-md">
          ...
          <div>
            ...
            <div className="space-y-4">
              {values.map((value, index) => (
                <div
                  key={index}
                  className="bg-white border border-gray-200 rounded-xl p-6 hover:shadow-2xl hover:border-primary-navy/20 hover:-translate-y-1 transition-all duration-300 group"
                >
            ...
            <div className="mt-8">
              <Link
                to="/about"
                className="w-full bg-primary-navy text-white py-4 px-6 rounded-xl font-semibold hover:bg-primary-navy/90 hover:shadow-lg transition-all duration-300 transform hover:scale-[1.02] inline-block text-center"
              >
                Discover Our Story
                <svg
